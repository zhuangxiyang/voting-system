package com.vote.common.mybatisplus.datasource.defaults;
...
import com.vote.common.mybatisplus.datasource.BaseDatabaseConfiguration;
import com.vote.common.mybatisplus.datasource.DatabaseProperties;
 ...
 * vote.database.multiTenantType != DATASOURCE时， 子类需要继承它，并让程序启动时加载
 * <p>
 ...
 * <p>
 * 1. 本类的子类的 @MapperScan(basePackages = {"com.vote"}) 修改为  @MapperScan(basePackages = {"com.vote.product.dao"})
 ...
 * 3. 在vote-xxx-server层复制该类，重命名为 SlaveDatabaseAutoConfiguration （跟AuthorityDatabaseAutoConfiguration放一起）
 ...
 * 6. SlaveDatabaseAutoConfiguration 中的 basePackages = {"com.vote"}, 修改为  basePackages = {"com.vote.order.dao"} # 这个路径根据你的情况修改
 ...
 * <p>
 * 完成上述修改后， 位于com.vote.product.dao 包下的dao 将操作  master 库， com.vote.order.dao中的dao 将操作slave库
 *
 * @author vote
 */
@Slf4j
