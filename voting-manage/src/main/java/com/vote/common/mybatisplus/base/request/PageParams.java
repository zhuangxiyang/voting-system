package com.vote.common.mybatisplus.base.request;
...
import com.vote.common.mybatisplus.utils.AntiSqlFilter;
...
public class PageParams<T> {
    ...
    @ApiModelProperty(value = "排序,默认updateTime", allowableValues = "id,createTime,updateTime", example = "id")
    private String sort = "createTime,id";
